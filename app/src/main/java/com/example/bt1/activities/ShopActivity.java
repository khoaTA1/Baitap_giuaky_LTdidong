...
public class ShopActivity extends AppCompatActivity implements ProductAdapter.OnProductClickListener {
    ...
    private void setupProductData() {
        ...
        // Tạo dữ liệu mẫu đa dạng hơn
        allProducts.add(new Product("iPhone 15 Pro Max", "29.990.000₫", R.drawable.iphone_15));
        allProducts.add(new Product("Samsung Galaxy S24 Ultra", "28.990.000₫", R.drawable.samsung_s23));
        allProducts.add(new Product("Xiaomi 14T Pro", "15.990.000₫", R.drawable.xiaomi_13t));
        allProducts.add(new Product("iPhone 14 Pro", "24.990.000₫", R.drawable.iphone_14));
        allProducts.add(new Product("OPPO Find X7", "22.990.000₫", R.drawable.iphone_15));
        allProducts.add(new Product("Samsung Galaxy A55", "8.990.000₫", R.drawable.samsung_s23));
        allProducts.add(new Product("Xiaomi Redmi Note 13", "4.990.000₫", R.drawable.xiaomi_13t));
        allProducts.add(new Product("iPhone 13", "18.990.000₫", R.drawable.iphone_14));
        allProducts.add(new Product("iPhone 16 Pro Max", "35.990.000₫", R.drawable.iphone_15)); 
        allProducts.add(new Product("Samsung Galaxy A24", "6.990.000₫", R.drawable.samsung_s23)); 
    ...
    private void showBrandFilter() {
        ...
        String[] brands = {"Tất cả", "iPhone", "Samsung", "Xiaomi", "OPPO"};
    ...
    private boolean filterByPriceRange(Product product, String priceRange) {
        ...
        double price = product.getPriceDouble();
    ...
    private void applySorting() {
        switch (sortType) {
            ...
            case "price_low":
                ...
                filteredProducts.sort((a, b) -> Double.compare(a.getPriceDouble(), b.getPriceDouble()));
                break;
            case "price_high":
                // sắp xếp cao đến thấp theo giá
                filteredProducts.sort((a, b) -> Double.compare(b.getPriceDouble(), a.getPriceDouble()));
                break;
            default:
                // Không sắp xếp
                break;
    ...
    private void setupBottomNavigation() {
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.nav_home) {
                ...
                Toast.makeText(ShopActivity.this, "Chuyển sang Giỏ hàng", Toast.LENGTH_SHORT).show();
                return true;
