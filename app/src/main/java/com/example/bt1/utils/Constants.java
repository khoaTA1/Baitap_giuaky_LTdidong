...
public class Constants {
    ...
    // Product Brands - Thương hiệu thực phẩm chức năng
    public static final String BRAND_LEANA = "LéAna";
    public static final String BRAND_IMMUVITA = "Immuvita";
    public static final String BRAND_NANO = "Nano";
    public static final String BRAND_LACTO = "Lacto";
