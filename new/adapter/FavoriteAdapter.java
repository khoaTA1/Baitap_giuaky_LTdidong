...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.FavoriteViewHolder> {
    ...
    class FavoriteViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView textProductName, textProductBrand, textProductPrice, textOriginalPrice, textStockStatus;
        private ImageButton btnRemoveFavorite, btnAddToCart;
        ...
        public void bind(Product product, int position) {
            ...
            // Set brand based on product name
            if (product.getName().contains("iPhone")) {
                textProductBrand.setText("Apple");
            } else if (product.getName().contains("Samsung")) {
                textProductBrand.setText("Samsung");
            } else if (product.getName().contains("Xiaomi")) {
                textProductBrand.setText("Xiaomi");
            } else if (product.getName().contains("OPPO")) {
                textProductBrand.setText("OPPO");
            } else if (product.getName().contains("Vivo")) {
                textProductBrand.setText("Vivo");
            } else {
                textProductBrand.setText("Khác");
            }
